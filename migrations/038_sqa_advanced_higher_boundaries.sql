...
INSERT INTO grade_boundaries
    (subject, board, paper_code, year, series,
     ...
     derived_from_course)
VALUES
    ('Biology (AH)', 'SQA', 'Section 1', '2019', 'June', NULL, 15, 13, 11, 9, NULL, TRUE),
    ('Biology (AH)', 'SQA', 'Section 2', '2019', 'June', NULL, 60, 51, 42, 38, NULL, TRUE),
    ('Economics (AH)', 'SQA', 'Question Paper', '2019', 'June', NULL, 56, 48, 40, 36, NULL, TRUE),
    ('Economics (AH)', 'SQA', 'Project', '2019', 'June', NULL, 28, 24, 20, 18, NULL, TRUE),
    ('English (AH)', 'SQA', 'Literary Study', '2019', 'June', NULL, 13, 11, 9, 8, NULL, TRUE),
    ('English (AH)', 'SQA', 'Textual Analysis', '2019', 'June', NULL, 13, 11, 9, 8, NULL, TRUE),
    ('English (AH)', 'SQA', 'Dissertation', '2019', 'June', NULL, 20, 17, 14, 13, NULL, TRUE),
    ('English (AH)', 'SQA', 'Portfolio', '2019', 'June', NULL, 20, 17, 14, 13, NULL, TRUE),
    ('French (AH)', 'SQA', 'Listening', '2019', 'June', NULL, 48, 41, 34, 31, NULL, TRUE),
    ('French (AH)', 'SQA', 'Reading', '2019', 'June', NULL, 34, 30, 24, 22, NULL, TRUE),
    ('French (AH)', 'SQA', 'Talking', '2019', 'June', NULL, 34, 30, 24, 22, NULL, TRUE),
    ('French (AH)', 'SQA', 'Portfolio', '2019', 'June', NULL, 21, 18, 15, 13, NULL, TRUE),
    ('Geography (AH)', 'SQA', 'Question Paper', '2019', 'June', NULL, 35, 29, 24, 21, NULL, TRUE),
    ('Geography (AH)', 'SQA', 'Folio A', '2019', 'June', NULL, 42, 35, 29, 26, NULL, TRUE),
    ('Geography (AH)', 'SQA', 'Folio B', '2019', 'June', NULL, 28, 23, 19, 17, NULL, TRUE),
    ('German (AH)', 'SQA', 'Listening', '2019', 'June', NULL, 49, 42, 35, 31, NULL, TRUE),
    ('German (AH)', 'SQA', 'Reading', '2019', 'June', NULL, 35, 30, 25, 22, NULL, TRUE),
    ('German (AH)', 'SQA', 'Talking', '2019', 'June', NULL, 35, 30, 25, 22, NULL, TRUE),
    ('German (AH)', 'SQA', 'Portfolio', '2019', 'June', NULL, 21, 18, 15, 14, NULL, TRUE),
    ('Maths (AH)', 'SQA', 'Paper 1', '2019', 'June', NULL, 22, 19, 15, 13, NULL, TRUE),
    ('Spanish (AH)', 'SQA', 'Listening', '2019', 'June', NULL, 48, 41, 34, 30, NULL, TRUE),
    ('Spanish (AH)', 'SQA', 'Reading', '2019', 'June', NULL, 34, 29, 24, 22, NULL, TRUE),
    ('Spanish (AH)', 'SQA', 'Talking', '2019', 'June', NULL, 34, 29, 24, 22, NULL, TRUE),
    ('Spanish (AH)', 'SQA', 'Portfolio', '2019', 'June', NULL, 20, 17, 15, 13, NULL, TRUE),
