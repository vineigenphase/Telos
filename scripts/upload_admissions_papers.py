...
STORAGE_DIR/admissions.
    ...
    set TELOS_ADMIN_EMAIL=you@example.com
    set TELOS_ADMIN_PASSWORD=...
...
def main(argv=None):
    ...
    if not (email and password):
        raise SystemExit(
            "set TELOS_ADMIN_EMAIL and TELOS_ADMIN_PASSWORD. Both stay out of "
            "this file and out of the shell history if you export them first.")
